 ...
 * @internal
 * */
export declare function ChangesError({error}: {error?: Error | null}): JSX_2.Element
 ...
 * @internal
 */
export declare function EditScheduleForm(props: PropsWithChildren<Props_2>): JSX_2.Element
...
declare const studioLocaleStrings: {
  ...
  'asset-sources.media-library.info.provisioning': string
...
declare const validationLocaleStrings: {
  ...
  readonly 'object.media-not-found': 'The asset could not found in the Media Library'
