...
var selector_isSelectingEntireBlocks = require("../_chunks-cjs/selector.is-selecting-entire-blocks.cjs"), util_sliceBlocks = require("../_chunks-cjs/util.slice-blocks.cjs"), types = require("@sanity/types"), selector_getFocusSpan = require("../_chunks-cjs/selector.get-focus-span.cjs"), selector_getTextBefore = require("../_chunks-cjs/selector.get-text-before.cjs");
const getAnchorBlock = (snapshot) => {
  ...
  if (!snapshot.context.selection)
    return;
  const selectionStartPoint = selector_getFocusSpan.getSelectionStartPoint(snapshot), selectionEndPoint = selector_isSelectingEntireBlocks.getSelectionEndPoint(snapshot);
...
function getListIndex({
  ...
  return (snapshot) => {
    ...
    }, focusTextBlock = selector_getFocusSpan.getFocusTextBlock({
      ...snapshot,
      context: {
        ...snapshot.context,
        selection
...
const getSelectedSlice = (snapshot) => selector_getFocusSpan.getSelectedValue(snapshot), getSelection = (snapshot) => snapshot.context.selection, getValue = (snapshot) => snapshot.context.value;
...
exports.getFocusBlock = selector_getFocusSpan.getFocusBlock;
exports.getFocusChild = selector_getFocusSpan.getFocusChild;
exports.getFocusSpan = selector_getFocusSpan.getFocusSpan;
exports.getFocusTextBlock = selector_getFocusSpan.getFocusTextBlock;
exports.getPreviousInlineObject = selector_getFocusSpan.getPreviousInlineObject;
exports.getSelectedValue = selector_getFocusSpan.getSelectedValue;
exports.getSelectionStartPoint = selector_getFocusSpan.getSelectionStartPoint;
exports.getSelectionText = selector_getFocusSpan.getSelectionText;
exports.isSelectionCollapsed = selector_getFocusSpan.isSelectionCollapsed;
exports.isSelectionExpanded = selector_getFocusSpan.isSelectionExpanded;
