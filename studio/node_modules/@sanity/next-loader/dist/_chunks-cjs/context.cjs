...
exports.comlinkProjectId = null;
exports.comlinkDataset = null;
...
function setComlinkClientConfig(nextComlinkProjectId, nextComlinkDataset) {
  exports.comlinkProjectId = nextComlinkProjectId, exports.comlinkDataset = nextComlinkDataset;
  for (const onComlinkChange of comlinkListeners)
    onComlinkChange();
}
...
exports.setComlinkClientConfig = setComlinkClientConfig;
