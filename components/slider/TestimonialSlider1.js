        ...
        <Swiper {...swiperOptions} className="thm-swiper__slider swiper-container">
            ...
            <SwiperSlide className="swiper-slide">
                ...
                <p className="testimonial-one__text">
                    OnPoint made sourcing from China effortless. Their team managed everything from manufacturer selection to final delivery. We received our products on time and in perfect condition.
                </p>
                </div>
            </SwiperSlide>
            ...
            <SwiperSlide className="swiper-slide">
                ...
                <p className="testimonial-one__text">
                    The quality control and transparency OnPoint provided were outstanding. We felt confident every step of the way.
                </p>
                </div>
            </SwiperSlide>
            {/*Testimonial One Single End*/}
            ...
            <SwiperSlide className="swiper-slide">
                ...
                <p className="testimonial-one__text">
                    OnPoint’s expertise in navigating Chinese regulations saved us time and money. Highly recommended for any business importing from China.
                </p>
                </div>
            </SwiperSlide>
            {/*Testimonial One Single End*/}
