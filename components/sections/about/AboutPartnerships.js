        ...
        <div className="row justify-content-center mb-4">
          <div className="col-xl-8 text-center">
            ...
            <p className="about-partnerships__desc">
              At OnPoint, we aim to build lasting relationships, not just transactions. Many of our clients have trusted us for years as their go-to partner for China sourcing.
            </p>
          </div>
        </div>
