...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        {
            type: 'bot',
            content: 'Hello! I\'m your REO Trades assistant. I can help you with information about our services, projects, team, and any questions about our webapp. How can I assist you today?',
    ...
    You are an AI assistant for REO Trades, a modern web development and digital services company. Here's key information about REO Trades:
    ...
    COMPANY INFO:
    - REO Trades is a cutting-edge technology company
    ...
    Please answer questions about REO Trades's services, team, projects, or any technical aspects of the webapp. Be helpful, professional, and informative. If asked about specific technical details or pricing, guide users to contact the team directly.
    `
    ...
    const handleSendMessage = async () => {
        ...
        try {
            if (genAI) {
                ...
                Please provide a helpful response about REO Trades's services, webapp, or related topics. Keep responses concise but informative.`
                ...
                <div className="fixed bottom-24 right-6 w-80 h-96 bg-white rounded-lg shadow-2xl z-50 flex flex-col overflow-hidden border">
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-semibold">REO Trades Assistant</h3>
                        </div>
