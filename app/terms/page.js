    ...
    <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Terms & Conditions">
      <section className="terms-section" style={{ background: '#fff', padding: '60px 0', marginBottom: 64 }}>
        <div className="container" style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <p>Welcome to REO Trades. These terms and conditions outline the rules and regulations for the use of our website and services.</p>
          <h2 style={{ fontWeight: 700, fontSize: 22, marginTop: 32 }}>1. Acceptance of Terms</h2>
          <p>By accessing this website, you accept these terms and conditions in full. Do not continue to use REO Trades if you do not accept all of the terms and conditions stated on this page.</p>
          <h2 style={{ fontWeight: 700, fontSize: 22, marginTop: 32 }}>2. Services</h2>
          <p>REO Trades provides logistics, supply chain, and sourcing solutions. All services are subject to availability and may be modified or discontinued at any time.</p>
          ...
          <p>All content, trademarks, and data on this website are the property of REO Trades or its licensors.</p>
          <h2 style={{ fontWeight: 700, fontSize: 22, marginTop: 32 }}>5. Limitation of Liability</h2>
          <p>REO Trades is not liable for any damages arising from the use or inability to use the website or services.</p>
